...
VALUES 	('FreezerCo.', '##1', 'Freezer - 5 Shelf', 0, NULL,
        ...
        ('Vacutainer', '###', 'Cryotube Vial', 1,
          ...
          NULL),
        ('Unknown', '##1', 'Mixed Sterile Tube', 1, NULL, NULL),
        ('DNA Genotek', 'OG-250', 'Oragene-DNA', 1, NULL, NULL)
;
...
VALUES ('Blood Collection',
       ...
       ('CBIG-P-0002 (DNA Extraction from Whole Blood)',
        (SELECT SpecimenProcessID FROM biobank_specimen_process WHERE Label='Collection'),
        (SELECT SpecimenTypeID FROM biobank_specimen_type WHERE Label='DNA')
       ),
       ('CBIG-P-0009 (DNA Extraction from Saliva)',
        (SELECT SpecimenProcessID FROM biobank_specimen_process WHERE Label='Collection'),
        (SELECT SpecimenTypeID FROM biobank_specimen_type WHERE Label='DNA')
       ),
       ('CBIG-P-0001 (PBMC Isolation)',
        (SELECT SpecimenProcessID FROM biobank_specimen_process WHERE Label='Collection'),
        (SELECT SpecimenTypeID FROM biobank_specimen_type WHERE Label='PBMC')
       ),
       ('CBIG-P-0014 (PBMC via Leucosep)',
        (SELECT SpecimenProcessID FROM biobank_specimen_process WHERE Label='Collection'),
        (SELECT SpecimenTypeID FROM biobank_specimen_type WHERE Label='PBMC')
       ),
       ('CBIG-P-0003 (Serum Isolation)',
        (SELECT SpecimenProcessID FROM biobank_specimen_process WHERE Label='Collection'),
...
VALUES 	('Clotted', (SELECT DatatypeID FROM biobank_specimen_attribute_datatype WHERE Datatype='boolean'), NULL), 
        ...
        ('DNA Quantification Date', (SELECT DatatypeID FROM biobank_specimen_attribute_datatype WHERE Datatype='date'), NULL), 
...
VALUES 	((select SpecimenProtocolID from biobank_specimen_protocol where Label='Blood Processing for PBMC (CBIG-P-0001)'),
        ...
        ((select SpecimenProtocolID from biobank_specimen_protocol where Label='Blood Processing for Serum (CBIG-P-0003)'), 
           (select SpecimenAttributeID from biobank_specimen_attribute where Label='Tube Expired'), 0),
        ((select SpecimenProtocolID from biobank_specimen_protocol where Label='Blood Processing for Serum (CBIG-P-0003)'), 
           (select SpecimenAttributeID from biobank_specimen_attribute where Label='Centrifuge Start #1'), 1),
        ((select SpecimenProtocolID from biobank_specimen_protocol where Label='Blood Processing for Serum (CBIG-P-0003)'), 
        ...
        ((select SpecimenProtocolID from biobank_specimen_protocol where Label='CBIG-P-0002 (DNA Extraction from Whole Blood)'),
           (select SpecimenAttributeID from biobank_specimen_attribute where Label='DNA Concentration (ng/µL)'), 0),
        ((select SpecimenProtocolID from biobank_specimen_protocol where Label='CBIG-P-0002 (DNA Extraction from Whole Blood)'),
           (select SpecimenAttributeID from biobank_specimen_attribute where Label='260/280 Ratio'), 0),
        ((select SpecimenProtocolID from biobank_specimen_protocol where Label='CBIG-P-0007 (Skin Biopsy)'),
           (select SpecimenAttributeID from biobank_specimen_attribute where Label='Incubation Start #1'), 1),
        ((select SpecimenProtocolID from biobank_specimen_protocol where Label='CBIG-P-0007 (Skin Biopsy)'),
           (select SpecimenAttributeID from biobank_specimen_attribute where Label='Incubation End #1'), 1),
